const tools = [{
  name: "Figma",
  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 lg:w-8 lg:h-8">
...
export const ToolsStrip = () => {
  ...
  return <div className="w-full mt-16 lg:mt-20 animate-fade-in-up animation-delay-500 my-[48px]">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="flex animate-scroll-left">
          {duplicatedTools.map((tool, index) => <div key={`${tool.name}-${index}`} className="flex-shrink-0 flex flex-col items-center gap-2 px-6 lg:px-10 group">
