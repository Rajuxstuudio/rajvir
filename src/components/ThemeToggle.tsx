...
export const ThemeToggle = () => {
  ...
  if (!mounted) {
    return (
      <button className="w-10 h-10 rounded-md bg-secondary shadow-md flex items-center justify-center">
  ...
  return (
    <button
      onClick={toggleTheme}
      className={cn(
        "w-10 h-10 rounded-md bg-secondary shadow-md flex items-center justify-center",
